...
public class ConsumerController {
	...
	@PostMapping("/edit")
	public ModelAndView updateConsumerAction(@ModelAttribute("consumer") @Valid Consumer consumer,BindingResult results) {
		ModelAndView mv = null;
	...
	@GetMapping("/delete")
	public String deleteAction(@RequestParam("id") long consumerId) {
